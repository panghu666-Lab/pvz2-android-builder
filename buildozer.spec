...
# (str) ANT framework directory (if empty, it will be automatically downloaded.)
#android.ant_path =
...
# (str) Full name including package path of the Java class to use for Android API 31+
...
# For example,
#  - libs/mysharedlibrary.so:mylib.so
#  - assets/myassets/
#android.add_assets =
...
# If you leave this blank, OUYA console support will not be enabled.
...
# (int) Python version to use in the build (3.8, 3.9, 3.10, 3.11)
...
# (str) Name of the apk to create
#p4a.apk_name =

# (list) The ndk API level to use (optional)
#p4a.ndk_api = 21
...
# (str) The development team to use for codesigning the release version
#ios.codesign.release_development_team = <hexstring>
